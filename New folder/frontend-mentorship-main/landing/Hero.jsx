      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-4 sm:px-6 lg:grid-cols-2 lg:gap-12 lg:px-8">
        ...
        <div className="text-center lg:text-left">
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-brand-200/70 bg-white/70 px-4 py-1.5 text-sm font-medium text-brand-700 shadow-sm backdrop-blur dark:border-brand-700/50 dark:bg-brand-950/40 dark:text-brand-300"
          >
            <Sparkles size={15} />
            New · AI-powered mentor matching 2.0
          </motion.div>
          ...
          >
            Grow faster with a mentor who <span className="text-gradient">gets you</span>
          </motion.h1>
